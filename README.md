...
- **[Project Management Professional (PMP)](./watermarked/PMP_Certificate_Diaz-Durana.pdf)** - PMI (2016)
- **[Data Analytics for Six Sigma](./watermarked/Data_Analytics_SixSigma_Certificate_Diaz-Durana.pdf)** - University of Amsterdam (2017)
- **[LEAN Manufacturing and Services](./watermarked/LEAN_Manufacturing_and_Services_Certificate_Diaz-Durana.pdf)** (2018)

### Academic Credentials
- **[Master of Science](./watermarked/Masterprüfung_Zeugnis_Diaz-Durana.pdf)** - Process, Energy & Environmental Systems Engineering, TU Berlin (2013)
...
```
Certificates/
├── watermarked/           # Watermarked PDFs for public sharing
├── [original PDFs]        # Not tracked in Git
└── README.md
```
...
- **Portfolio**: [github.com/albertodiazdurana/data-science-portfolio](https://github.com/albertodiazdurana/data-science-portfolio)

---

*Watermarked versions provided for public reference. Original certificates available upon request.*
